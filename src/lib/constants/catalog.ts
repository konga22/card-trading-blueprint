export const CATALOG_GAME_KEYS = ['all', 'pokemon', 'yugioh', 'onepiece', 'other'] as const;
export type CatalogGameKey = (typeof CATALOG_GAME_KEYS)[number];

export const CATALOG_PURPOSE_KEYS = ['beginner', 'collection', 'play', 'rare'] as const;
...
export const CATALOG_CONDITION_KEYS = ['mint', 'near_mint', 'good', 'graded'] as const;
...
export const CATALOG_SORT_KEYS = ['popular', 'latest', 'low_price', 'high_price', 'recent_trade'] as const;
