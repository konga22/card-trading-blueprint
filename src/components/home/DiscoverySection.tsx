...
export function DiscoverySection({ section }: { section: DiscoverySectionData }) {
  ...
  return (
    <HomeSection
      ...
      action={
        <Link className={styles.sectionLink} href={sectionHref}>
          전체 보기
        </Link>
      }
    >
