...
const sellSteps = [
  ...
  },
  {
    label: "STEP 02",
    title: "최근 거래가 비교",
    description: "직전 거래가와 현재 거래 범위를 같이 보면 기준 가격을 더 쉽게 잡을 수 있습니다.",
  },
  {
    label: "STEP 03",
    title: "신뢰 정보까지 같이 등록",
    description: "검수 가능 여부와 안전결제 기준까지 확인한 뒤 판매를 시작합니다.",
  },
];
...
export function SellStartPage() {
  return (
    <PageScaffold
      ...
      description="가격 확인과 카드 정보 입력을 한 화면에 섞지 않고, 판매 전용 흐름에서 필요한 것만 먼저 보여줍니다."
      actions={
        <>
