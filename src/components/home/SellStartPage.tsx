...
const sellSteps = [
  {
    label: "STEP 01",
    title: "카드 정보 먼저 정리",
    description: "세트, 카드번호, 상태를 먼저 정리하면 판매 등록 흐름이 훨씬 빠르게 이어집니다.",
  },
  {
    label: "STEP 02",
    title: "최근 거래가 비교",
    description: "직전 거래가와 현재 거래 범위를 함께 보면서 기준 가격을 먼저 익힙니다.",
  },
  {
    label: "STEP 03",
    title: "신뢰 정보와 함께 등록",
    description: "검수 가능 여부와 안전결제 노출 기준을 확인한 뒤 판매를 시작합니다.",
  },
];
...
export function SellStartPage() {
  return (
    <PageScaffold
      ...
      description="가격 확인과 카드 정보 입력을 한 화면에서 우겨넣지 않고, 판매 전용 흐름에서 필요한 것만 먼저 보여줍니다."
      actions={
        <>
      ...
      aside={
        <div className={styles.infoStack}>
          ...
          <p className={styles.infoText}>
            카드번호, 상태, 사진, 최근 거래가를 미리 정리해 두면 등록 전환이 훨씬
            자연스럽습니다.
          </p>
        </div>
      }
