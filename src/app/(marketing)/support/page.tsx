  ...
  return (
    <SimpleInfoPage
      ...
      cards={[
        {
          label: "구매 문의",
          title: "거래 진행 중 막히는 지점",
          description: "결제, 응답, 거래 확인 과정에서 자주 막히는 흐름을 먼저 정리합니다.",
        },
        {
          label: "판매 문의",
          title: "등록과 응답 관리",
          description: "판매 등록 이후 확인해야 할 정보와 다음 행동을 단계별로 나눕니다.",
        },
        {
          label: "검색 문의",
          title: "검색과 필터 사용법",
          description: "카드번호, 세트, 상세 필터를 언제 어떻게 써야 하는지 짧게 안내합니다.",
        },
      ]}
    />
  );
